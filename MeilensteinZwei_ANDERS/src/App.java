...
//	
//	//getRowSortColBlock INPUT		
//	int[] row1 = {+2,+1,+3,+2,+1,+3,+2,+1,+3};
//	int[] row2 = {+1,+3,+2,+1,+3,+2,+1,+3,+2};
//	int[] row3 = {+8,+9,+7,+8,+9,+7,+9,+8,+7};
//	int[] row4 = {+3,+2,+1,+3,+2,+1,+3,+2,+1};
//	int[] row5 = {+5,+4,+6,+5,+4,+6,+5,+4,+6};
//	int[] row6 = {+9,+7,+8,+9,+7,+8,+7,+9,+8};
//	int[] row7 = {+6,+5,+4,+6,+5,+4,+6,+5,+4};
//	int[] row8 = {+4,+6,+5,+4,+6,+5,+4,+6,+5};
//	int[] row9 = {+7,+8,+9,+7,+8,+9,+8,+7,+9};
//	
